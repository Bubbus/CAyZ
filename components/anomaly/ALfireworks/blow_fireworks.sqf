...
_sparks_fire setParticleParams [["\A3\data_f\kouleSvetlo",1,0,1],"","Billboard",.1,0.5,[0,0,0],[0,0,10],0,20,8,0,[4],[[_ro,_ve,_bl,1]],[1],0,0,"components\anomaly\ALfireworks\trail_fireworks_sec.sqf","components\anomaly\ALfireworks\blow_fireworks_fin.sqf",[_this#0,_this#1,_this#2]];
