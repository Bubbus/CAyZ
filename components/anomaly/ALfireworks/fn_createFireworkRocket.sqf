...
drop [["\A3\data_f\cl_exp",1,0,1],"","Billboard",0.02,_time_life_projectile,[0,0,2],[0,0,200],0,11,8,0,[5],[[1,1,1,1]],[1],1,0,"components\anomaly\ALfireworks\trail_fireworks.sqf","components\anomaly\ALfireworks\blow_fireworks.sqf",_obj];
